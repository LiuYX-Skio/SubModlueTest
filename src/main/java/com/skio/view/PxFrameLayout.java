 ...
 */
public class PxFrameLayout extends FrameLayout {
    private final PxLayoutHelper mHelper = new PxLayoutHelper(this);

    public PxFrameLayout(Context context) {
        super(context);
    }

    public PxFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PxFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams
        ...
        public LayoutParams(LayoutParams source) {
            ...
            mPxLayoutInfo = source.mPxLayoutInfo;
        }
