 ...
 */
public class PxRelativeLayout extends RelativeLayout {
    private final PxLayoutHelper mHelper = new PxLayoutHelper(this);

    public PxRelativeLayout(Context context) {
        super(context);
    }

    public PxRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PxRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
